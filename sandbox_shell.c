...
// Inspired by this tutorial (https://brennan.io/2015/01/16/write-a-shell-in-c/)
...
int shl_help(char **args) {
    int i;
    printf("Chris & Jared's SANDBOX_SHELL\n");
...
void shl_loop() {
	...
	printf("\e[1;1H\e[2JWELCOME TO THE " TEXT_BOLD_RED "SANDBOX " TEXT_DEFAULT "SHELL\n\n");
